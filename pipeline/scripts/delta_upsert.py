...
def build_uris(stage: str, links_type: str, params: dict) -> dict[str, str]:
    ...
    return {
        ...
        "delta_path": f"s3://{bucket}/links/delta/{dataset}/{links_type}/",
        "snapshot_path": f"s3://{bucket}/links/snapshots/{dataset}/{links_type}/",
...
def main():
    ...
    for links_type in ["h", "nh"]:
        ...
        raw_df = spark.read.parquet(uris["raw_path"] + "*.parquet.snappy")
